...
const calcularClasificacionOMA = (fechaSintomas) => {
    ...
    if (tieneOS === 'si' && fechaOS) {
        ...
        const calcularFiltradoGlomerular = (cr, edad, peso, talla, sexo) => {
            if (!cr || !edad || !peso || !talla || !sexo) return '';
            
            // Calcular superficie corporal (fórmula de Mosteller)
            const sc = Math.sqrt((peso * talla) / 3600);
            
            // Calcular filtrado base
            let fg = (140 - edad) * peso / (72 * cr);
...
return React.createElement('div', { style: styles.mainContainer },
    ...
    React.createElement('div', { style: styles.header },
        React.createElement('h1', { style: styles.headerTitle }, 
    ...
    React.createElement('div', { style: styles.formContainer },
        React.createElement('div', { style: styles.grid },
            // Primera fila: Piso/Cama, Edad, Peso
            React.createElement('div', { style: styles.row },
                ...
                React.createElement('div', { style: styles.compact },
                    ...
                    React.createElement('span', { style: styles.unitText }, 'años')
                ),
                React.createElement('div', { style: styles.compact },
                    ...
                    React.createElement('span', { style: styles.unitText }, 'Kg')
                )
            ),
            ...
            // Segunda fila: Sexo y Procedencia
                                ...
                                React.createElement('div', { style: { display: 'flex', gap: '1rem' } },
                                    React.createElement('label', { style: { display: 'flex', alignItems: 'center', gap: '0.5rem' } },
                                        ...
                                        React.createElement('input', {
                                            ...
                                            onChange: () => handleRadioClick('sexo', 'H'),
                                            style: styles.radio
                                        })
                                    ),
                                    React.createElement('label', { style: { display: 'flex', alignItems: 'center', gap: '0.5rem' } },
                                        ...
                                        React.createElement('input', {
                                            ...
                                            onChange: () => handleRadioClick('sexo', 'M'),
                                            style: styles.radio
                                        })
                                    )
                                )
                            ),
                            React.createElement('div', { style: {...styles.inputGroup, flex: 1} },
                        ...
                        React.createElement('div', { style: styles.row },
                            ...
                            React.createElement('div', { style: styles.compact },
                                ...
                                React.createElement('span', { style: styles.unitText }, 'cm')
                            )
                        ),
            
                        // Quinta fila: Fechas
                        React.createElement('div', { style: styles.dateContainer },
                            React.createElement('div', { style: styles.dateColumn },
                            ...
                            React.createElement('div', { style: styles.dateGroup },
                                React.createElement('span', { style: styles.dateLabel }, 'F consulta:'),
                                React.createElement('input', { 
                                    type: 'date',
...
// AQUÍ COMIENZA LA NUEVA SECCIÓN DE PARACLÍNICA
           React.createElement('div', { style: { marginTop: '2rem', border: '1px solid #333', padding: '1rem' } },
               ...
               React.createElement('table', { style: styles.table },
                  ...
                  // Cuerpo de la tabla
                  React.createElement('tbody', null,
                      Object.entries(paraclinicaData.valores).flatMap(([variable, datos]) => {
                          ...
                          if ((variable === 'bd' || variable === 'bi' || variable === 'alb' || 
                               ...
                               variable === 'ggt') && !datos.visible && !paraclinicaData.valores.bt.valores.some(v => v)) return [];

                          const filaNormal = React.createElement('tr', { key: variable },
                          ...
                          // Si es Cr, agregar la fila del FG
                          if (variable === 'cr') {
                              const filaFG = React.createElement('tr', { key: 'fg' },
                                  // Columna de etiqueta FG
                                  React.createElement('td', {
                                      style: {
                                          ...styles.tableCell,
                                          fontWeight: 'bold',
                                  ...
                                  // Columnas de valores calculados
                                  paraclinicaData.columnas.map((_, colIndex) => {
                                      const crValue = datos.valores[colIndex];
                                      const fgValue = calcularFiltradoGlomerular(
                                          crValue,
                                          formData.age,
                                          formData.peso,
                                          formData.talla,
                                          radioSelections['sexo']
                                      );
                                      return React.createElement('td', {
                                          ...
                                          style: {
                                              ...styles.tableCell,
                                              backgroundColor: '#f8f9fa',
                                              color: fgValue < 60 ? '#dc3545' : '#198754'  // rojo si < 60, verde si ≥ 60
                                          }
                                      }, fgValue);
                                  })
                              );
                              return [filaNormal, filaFG];
                          }
